...
const FooterBlock = ({ header, footerLinks }) => (
...
const Footer = () => {
  return (
    <footer
      className="lg:px-4 w-full h-full relative flex flex-col items-center"
      id="footer"
    >
      <div
        className="grid grid-cols-2 md2:h-64 md:py-16 py-10 md2:py-0 lg:px-24 md2:px-10 bg-themeBlue1 rounded shadow justify-between absolute -top-36"
        style={{ width: "90%" }}
      >
      ...
      <div className="bg-black rounded pt-40 pb-8 md:px-16 px-5">
